...
public class Joc extends  Entity<Integer> {
    ...
    private String cuvant1,cuvant2,cuvant3;
    private String litera1,litera2,litera3;
    ...
    public Joc(String cuvant1, String cuvant2, String cuvant3, String litera1, String litera2, String litera3) {
